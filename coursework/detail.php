...
<link href="#" type="text/css" rel="stylesheet">
    <title>KL tours | Package Details</title>
...

{
  ...
  <strong><center>Package edited successfully !</center></strong>
</div>
</br>
<?php
unset($_SESSION['editpackage']);
}
?>
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<table>";
      ...
      echo "<tr>";
        ...
        echo '<td><img src="food1.jpg" style="width:200px;height:200px"></br>Twisties<br>(RM1.20 each)</br></br>Amount: '.$food1.'</td>';
      


        echo '<td><img src="food2.jpg" style="width:200px;height:200px"></br>Chips<br>(RM1.70 each)</br></br>Amount: '.$food2.'</td>';
      
      
        echo '<td><img src="food3.jpg" style="width:200px;height:200px"></br>Cookies<br>(RM2.20 each)</br></br>Amount '.$food3.'</td>';
      ...
      echo "<tr>";
        ...
        echo '<td><img src="food4.jpg" style="width:200px;height:200px"></br>Soya<br>(RM2.00 each)</br></br>Amount: '.$food4.'</td>';
       


        echo '<td><img src="food5.jpg" style="width:200px;height:200px"></br>100 Plus<br>(RM2.50 each)</br></br>Amount: '.$food5.'</td>';
        

    
        echo '<td><img src="food6.jpg" style="width:200px;height:200px"></br>Mineral Water<br>(RM1.80 each)</br></br>Amount: '.$food6.'</td>';
...
<a href="<?php echo("edit.php?package=".$package) ?>"  class="button">EDIT PACKAGE</a>
</br></br>
<a href="<?php echo("delete.php?package=".$package) ?>" onclick="return confirm('Are you sure?');" class="button">DELETE</a>
